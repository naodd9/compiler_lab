...
boolexpr
    : boolexpr AND boolexpr {
        ...
        llvm::Value* boolVal = Builder->CreateICmpNE($1,
            llvm::ConstantInt::get(*TheContext, llvm::APInt(1, 0, false)), "and.left");
        llvm::BasicBlock* rightBB = llvm::BasicBlock::Create(*TheContext, "and.right", MainFn);
        Builder->CreateCondBr(boolVal, rightBB, endBB);
    ...
    | boolexpr OR boolexpr {
        ...
        llvm::Value* boolVal = Builder->CreateICmpNE($1,
            llvm::ConstantInt::get(*TheContext, llvm::APInt(1, 0, false)), "or.left");
        llvm::BasicBlock* rightBB = llvm::BasicBlock::Create(*TheContext, "or.right", MainFn);
        Builder->CreateCondBr(boolVal, endBB, rightBB);
        Builder->SetInsertPoint(rightBB);
        $$ = $3;
        Builder->CreateBr(endBB);
        Builder->SetInsertPoint(endBB);
