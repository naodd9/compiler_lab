...
{
       0,    47,    47,    48,    52,    57,    61,    76,    77,    91,
      92,   108,   118,   119,   120,   121,   122,   123
};
#endif
...
{
     -23,     0,   -23,   -23,    -5,   -23,     9,     7,     7,   -23,
      32,     7,     7,   -16,   -11,   -23,    17,     7,     7,     7,
       7,   -23,    39,   -15,    21,     7,   -23,   -22,   -22,   -23,
     -23,   -23,     5,     3,    23,     7,    15,   -23,    46,   -23,
     -23
};
...
{
       2,     0,     1,     9,    11,     8,     0,     0,     0,     3,
       0,     0,     0,     0,    11,    17,     0,     0,     0,     0,
       0,     7,     0,     0,     0,     0,    16,    12,    13,    14,
      15,     4,    10,     0,     0,     0,     0,    10,     0,     5,
       6
};
...
{
       2,    19,    20,     3,     4,     5,    17,    18,    19,    20,
       3,    14,    24,    13,    32,    15,    16,    25,     6,    22,
      23,    11,     7,    12,    33,    27,    28,    29,    30,     7,
       8,    35,    36,    34,     0,     0,     0,     8,    17,    18,
      19,    20,    39,    38,    17,    18,    19,    20,    26,     0,
       0,     0,    37,    17,    18,    19,    20,     0,     0,    21,
      17,    18,    19,    20,     0,     0,    31,    17,    18,    19,
      20,     0,     0,    40
};

static const yytype_int8 yycheck[] =
{
       0,    23,    24,     3,     4,     5,    21,    22,    23,    24,
       3,     4,    28,     4,    29,     7,     8,    28,    18,    11,
      12,    26,    22,    28,     3,    17,    18,    19,    20,    22,
      30,    26,    29,    25,    -1,    -1,    -1,    30,    21,    22,
      23,    24,    27,    35,    21,    22,    23,    24,    31,    -1,
      -1,    -1,    29,    21,    22,    23,    24,    -1,    -1,    27,
...
#line 57 "parser.y"
                                    {
        SymTab.declareArray((yyvsp[-4].sval), (yyvsp[-2].ival), MainFn);
        free((yyvsp[-4].sval));
      }
#line 1149 "parser.tab.c"
    break;

  case 6: /* stmt: IDENT '[' expr ']' '=' expr ';'  */
#line 61 "parser.y"
                                      {
